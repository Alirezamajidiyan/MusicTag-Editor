...
class Mp3Panel(wx.Panel): 
    def __init__(self, parent):
        ...
        title_label = wx.StaticText(self, label="Mp3 Tag Editor")
        title_label.SetFont(title_font)
        title_label.SetForegroundColour(wx.Colour(94, 44, 222))  # Set text color to blue
...
class Mp3Frame(wx.Frame):
    ...
    def create_menu(self):
        ...
        about_menu = wx.Menu()
        github_menu_item = about_menu.Append(
            wx.ID_ANY, 'GitHub', 
            'Link to my GitHub'
        )
        self.Bind(
            event=wx.EVT_MENU, 
            handler=self.on_open_github,
            source=github_menu_item,
        )
        
        menu_bar.Append(file_menu, '&File')
        menu_bar.Append(about_menu, '&About me')
    ...
    def on_open_github(self, event):
        webbrowser.open('https://github.com/Alirezamajidiyan')
